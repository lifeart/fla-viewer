...
const allVariants = [
  ...
  { name: 'dense-priority2-edge-tone-0', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 0 } } },
  { name: 'dense-priority2-edge-tone-8', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 8 } } },
  { name: 'dense-priority2-edge-tone-12', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 12 } } },
  { name: 'dense-priority2-edge-tone-16', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 16 } } },
  { name: 'dense-priority2-edge-tone-18', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 18 } } },
  { name: 'dense-priority2-edge-tone-20', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 20 } } },
  { name: 'dense-priority2-edge-tone-22', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 22 } } },
  { name: 'dense-priority2-edge-tone-24', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 24 } } },
  { name: 'dense-priority2-edge-tone-28', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 28 } } },
  { name: 'dense-priority2-edge-tone-32', renderOptions: { denseLineFillTuning: { priority2CarrierEdgeToneSubtract: 32 } } },
  {
    name: 'dense-sat-relief-all-24',
  ...
  {
    name: 'dense-sat-relief-all-16',
    renderOptions: { denseLineFillTuning: { saturatedFillReliefMaxFractionalAlphaPixels: 100000, saturatedFillDensitySubtract: 16 } },
  },
  {
    name: 'dense-ink-28',
    renderOptions: { denseLineFillTuning: { inkDensitySubtract: 28 } },
  },
  {
