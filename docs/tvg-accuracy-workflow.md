...
- Current raw benchmark after dense line-fill exterior expansion scale `0.78`, 12-tile bitmap edge-tone eligibility refinement, and moderate-aspect clipped atlas edge tone: overall `98.67`, vector `98.56`, bitmap `99.27`.
- Source-fresh raw average before trust classification is overall `99.21`, vector `99.19`, bitmap `99.27`.
- Trusted source-fresh raw average excludes stale, alternate-source, suspicious sparse-overlap, and noisy low-foreground thumbnails: overall `99.27`, vector `99.27`, bitmap `99.27`.
- Current trusted source-fresh raw minimum is `color.101/color-21` at `97.37`; trusted source-fresh bitmap minimum is now `3255/3255-1` at raw `97.91`.
